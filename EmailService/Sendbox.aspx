                ...
                <div class="grid email">
                    <div class="grid-body">
                        <div class="row">
                            <!-- BEGIN INBOX MENU -->
                            <div class="col-md-3">
                                <h2 class="grid-title"><i class="fa fa-inbox"></i>Sendbox</h2>
                                            ...
                                            <div>
                                                <asp:GridView ID="SendboxGridView" runat="server" AutoGenerateColumns="false" OnRowCommand="SendboxGridView_RowCommand" class="table table-bordered table-condensed table-responsive table-hover">
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="ReceiverUserName" HeaderText="Receiver" />
                                                        <asp:BoundField DataField="SentDate" HeaderText="Send Date" DataFormatString="{0:MM/dd/yyyy}" />
